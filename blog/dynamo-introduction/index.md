...
<blurhash-image url="/dynamo-introduction/img1.png" preview='{"blurhash":"U8SF;LD*%gofIUM|xuRj~qaeM{RjxtoIWBWC","w":364,"h":196}'>
...
<blurhash-image url="/dynamo-introduction/img2-sized.png" preview='{"blurhash":"U4SY{p4._4D%V]RjRit6?Ixt-.xuNFIVx^NG","w":675,"h":319}'>
  <img alt="Query execution plan" width="675" height="319" src="/dynamo-introduction/img2-sized.png" slot="image" />
  <canvas width="675" height="319" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/dynamo-introduction/img3-sized.png" preview='{"blurhash":"U4SY{p0K~qIUjbs:M_jY-pxa?axao#E1t8Rk","w":675,"h":308}'>
  <img alt="Query execution plan" width="675" height="308" src="/dynamo-introduction/img3-sized.png" slot="image" />
  <canvas width="675" height="308" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/dynamo-introduction/img4-sized.png" preview='{"blurhash":"UBS6JYX8~Cs:GXWB?Gs:.QjZM|bH:Uoy56R*","w":1000,"h":299}'>
  <img alt="B+ Tree 1" width="1000" height="299" src="/dynamo-introduction/img4-sized.png" slot="image" />
  <canvas width="1000" height="299" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/dynamo-introduction/img5-sized.png" preview='{"blurhash":"UJRC_Is:~VRQK#oy-VWV~BR*E2ay+}WBNGaf","w":1000,"h":277}'>
  <img alt="B+ Tree 2" width="1000" height="277" src="/dynamo-introduction/img5-sized.png" slot="image" />
  <canvas width="1000" height="277" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/dynamo-introduction/img6-sized.png" preview='{"blurhash":"U4SY{q4o_ND*RjoJM_o0-;%2-:xaS4E1tSRk","w":675,"h":327}'>
  <img alt="Query execution plan" width="675" height="327" src="/dynamo-introduction/img6-sized.png" slot="image" />
  <canvas width="675" height="327" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/dynamo-introduction/img7.png" preview='{"blurhash":"U9SF;KIUt7xubIIUxuof~qRjWAWBocoIjsay","w":474,"h":186}'>
  <img alt="Query results" width="474" height="186" src="/dynamo-introduction/img7.png" slot="image" />
  <canvas width="474" height="186" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/dynamo-introduction/img8-sized.png" preview='{"blurhash":"U4SY{p0K~qM{t8jZM_s.-qoJ?H%1tRD%t9R-","w":675,"h":273}'>
  <img alt="Query execution plan" width="675" height="273" src="/dynamo-introduction/img8-sized.png" slot="image" />
  <canvas width="675" height="273" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/dynamo-introduction/img9-sized.png" preview='{"blurhash":"U3Ss4~00~qxu9GD%9Ft7_3-pn$s.?bM{%M%M","w":1000,"h":406}'>
  <img alt="Query execution plan" width="1000" height="406" src="/dynamo-introduction/img9-sized.png" slot="image" />
  <canvas width="1000" height="406" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/dynamo-introduction/img10.png" preview='{"blurhash":"U9SPX^IUt8t7RjIUtRof~qRjWAWBxaoeWAWB","w":484,"h":202}'>
  <img alt="Query results" width="484" height="202" src="/dynamo-introduction/img10.png" slot="image" />
  <canvas width="484" height="202" slot="preview"></canvas>
</blurhash-image>

<blurhash-image url="/dynamo-introduction/img11-sized.png" preview='{"blurhash":"U4SY~x0K_4NGa#aeM_oc?Hs.-:%2tRD*tRWX","w":675,"h":282}'>
  <img alt="Query execution plan" width="675" height="282" src="/dynamo-introduction/img11-sized.png" slot="image" />
  <canvas width="675" height="282" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/dynamo-introduction/img12-sized.png" preview='{"blurhash":"UqLXVzt7WBRk00t7WBWB~qj]WBWB?bayj[of","w":1000,"h":366}'>
  <img alt="Dynamo table" width="1000" height="366" src="/dynamo-introduction/img12-sized.png" slot="image" />
  <canvas width="1000" height="366" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/dynamo-introduction/img13-sized.png" preview='{"blurhash":"U+I=Pzt7WCR*D%t7WBWB~qfQfRazWBfQofof","w":1000,"h":297}'>
  <img alt="Dynamo query" width="1000" height="297" src="/dynamo-introduction/img13-sized.png" slot="image" />
  <canvas width="1000" height="297" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/dynamo-introduction/img14-sized.png" preview='{"blurhash":"UlNwWet7azWB00t7WBj@?bj]WBWB~qWBayj[","w":1000,"h":286}'>
  <img alt="Dynamo gsi" width="1000" height="286" src="/dynamo-introduction/img14-sized.png" slot="image" />
  <canvas width="1000" height="286" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/dynamo-introduction/img15-sized.png" preview='{"blurhash":"U+Jko;t7RjWBD%ofRjax~qa|j[fQaefkofof","w":1000,"h":343}'>
