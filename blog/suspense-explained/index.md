...
<blurhash-image url="/suspense-explained/booklistView-sized.png" preview='{"blurhash":"U1RMh~00000000_N~V?G00%gK5Me00NL-X^+","w":1000,"h":589}'>
  <img alt="Book list UI" width="1000" height="589" src="/suspense-explained/booklistView-sized.png" slot="image" />
  <canvas width="1000" height="589" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/suspense-explained/initialWaterfall-sized.png" preview='{"blurhash":"UBQc;l:]$+J#}dBL^lNF$l%31D^lNYjZ-WNF","w":1000,"h":168}'>
  <img alt="Initial Waterfall" width="1000" height="168" src="/suspense-explained/initialWaterfall-sized.png" slot="image" />
  <canvas width="1000" height="168" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/suspense-explained/initialWaterfallFixed-sized.png" preview='{"blurhash":"UEQ0y~}K=~0]}dKHbq=$-XgINZ$,NYs;xaSd","w":1000,"h":201}'>
  <img alt="Waterfall fixed" width="1000" height="201" src="/suspense-explained/initialWaterfallFixed-sized.png" slot="image" />
  <canvas width="1000" height="201" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/suspense-explained/incrementalWaterfall-sized.png" preview='{"blurhash":"U6Q][{;D^,B1}KlO%M$A%3-qEw=~0crx^mF:","w":1000,"h":140}'>
  <img alt="Another Waterfall" width="1000" height="140" src="/suspense-explained/incrementalWaterfall-sized.png" slot="image" />
  <canvas width="1000" height="140" slot="preview"></canvas>
</blurhash-image>
...
<blurhash-image url="/suspense-explained/incrementalWaterfallFixed-sized.png" preview='{"blurhash":"U8Q,UPR6~EFp}s?bO8$SIut7t7%2D~aN-WS^","w":1000,"h":141}'>
  <img alt="Waterfall fixed" width="1000" height="141" src="/suspense-explained/incrementalWaterfallFixed-sized.png" slot="image" />
  <canvas width="1000" height="141" slot="preview"></canvas>
</blurhash-image>
